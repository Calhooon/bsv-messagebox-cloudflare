...
| Auth | BRC-31 mutual identity (bsv-middleware-cloudflare) |
...
~/bsv/rust-middleware/bsv-middleware-cloudflare   → BRC-31 auth middleware
...
npx wrangler d1 create rust-message-box
